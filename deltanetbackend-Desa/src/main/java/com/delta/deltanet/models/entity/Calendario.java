...
public class Calendario {
    ...
    @Column(name = "id_feriado", nullable = true)
    private Long idFeriado;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "id_feriado", insertable = false, updatable = false)
    private AdmCalendarioFeriado calendarioFeriado;
	...
	public AdmCalendarioFeriado getCalendarioFeriado() {
		return calendarioFeriado;
	}

	public void setCalendarioFeriado(AdmCalendarioFeriado calendarioFeriado) {
