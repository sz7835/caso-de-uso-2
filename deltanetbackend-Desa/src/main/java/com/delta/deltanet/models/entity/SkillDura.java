...
@Entity
@Table(name="out_hab_dura")
public class SkillDura {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name="id")
    private Long id;

    @Column(name="id_out_hab_dura_clas",insertable = false,updatable = false)
    private Long idClas;

    @OneToOne
    @JoinColumn(name = "id_out_hab_dura_clas")
    private SkillDuraClas duraClas;
    ...
    public SkillDuraClas getDuraClas() {
        return duraClas;
    }

    public void setDuraClas(SkillDuraClas duraClas) {
        this.duraClas = duraClas;
    }
