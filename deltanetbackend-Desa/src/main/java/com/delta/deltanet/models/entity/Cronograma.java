...
public class Cronograma implements Serializable {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "cronograma",cascade = CascadeType.ALL)
    @JsonIgnore
    public List<LiquidacionCronograma> liquids;
	
	@OneToOne
	@JoinColumn(name = "id_modalidad",insertable = false,updatable = false)
	private CronogramaModalidad modalidad;
	...
	public CronogramaModalidad getModalidad() {
		return modalidad;
	}

	public void setModalidad(CronogramaModalidad modalidad) {
